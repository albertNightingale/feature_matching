...
def optimize(p0, x_0s, x_1s):
    ...
    result = least_squares(objective_function, x0=p0, args=(x_0s, x_1s), method='lm', jac='2-point', verbose=2, max_nfev=50000)
    print("completed", result.success, result.message)
